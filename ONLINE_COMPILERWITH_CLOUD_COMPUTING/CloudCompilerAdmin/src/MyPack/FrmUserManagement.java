 ...
 * @author OorjaTech
 */
public class FrmUserManagement extends javax.swing.JFrame {

    /**
     * Creates new form FrmUserManagement
     */
    Database userdb;
    Vector<SingleLog> usage;
    public FrmUserManagement() {
        initComponents();
        Dimension sd  = Toolkit.getDefaultToolkit().getScreenSize();
        setLocation(sd.width / 2 - this.getWidth()/ 2, sd.height / 2 - this.getHeight()/ 2);
        usage = new Vector<SingleLog>();
        readFromFile();
        fillUserList();
    ...
    private void jList1ValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_jList1ValueChanged
        ...
        if(index == -1) return;
        String uid = "";
        jTextField1.setText(userdb.allUsers.elementAt(index).fullName);
        jTextArea1.setText(userdb.allUsers.elementAt(index).address);
        jTextField3.setText(userdb.allUsers.elementAt(index).country);
        jTextField4.setText(userdb.allUsers.elementAt(index).contact);
        jTextField5.setText(userdb.allUsers.elementAt(index).email);
        uid = userdb.allUsers.elementAt(index).userID;
        jTextField2.setText(uid);
        String dt = userdb.allUsers.elementAt(index).DOB.get(Calendar.DAY_OF_MONTH) + "/" + userdb.allUsers.elementAt(index).DOB.get(Calendar.MONTH) + "/" + userdb.allUsers.elementAt(index).DOB.get(Calendar.YEAR);
        jTextField6.setText(dt);
        usage.clear();
        for(int i=0;i<userdb.logList.size();i++){
            if(userdb.logList.elementAt(i).uid.equals(uid)){
                usage.addElement(userdb.logList.elementAt(i));
            }
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        new DlgUsageStats(this, true, usage).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmUserManagement.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
